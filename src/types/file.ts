...
export interface IFileSystemService {
  ...
  copyFile(sourceUri: string, destinationUri: string): Promise<FileOperationResult>;
  moveFile(sourceUri: string, destinationUri: string): Promise<FileOperationResult>;
  ...
  // 安全操作
  secureFile(uri: string, options: FileSecurityOptions): Promise<FileOperationResult>;
