...
export const playbackSelectors = {
  ...
  // === 控制状态 ===
  getCanPlay: (state: PlaybackState) => !state.isLoading && !state.error,
  ...
  getCanSkipNext: (state: PlaybackState) => false, // 暂时返回false，后续可以添加队列逻辑
  getCanSkipPrevious: (state: PlaybackState) => false, // 暂时返回false，后续可以添加队列逻辑
  getHasNext: (state: PlaybackState) => false, // 暂时返回false，后续可以添加队列逻辑
  getHasPrevious: (state: PlaybackState) => false, // 暂时返回false，后续可以添加队列逻辑
...
export const usePlaybackSelector = <T>(
  ...
  return usePlaybackStore(selector);
};
